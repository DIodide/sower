 ...
 * `ORDER BY priority DESC` sorts Highest → High → Normal → Low. Shared here
 * so the dashboard UI and the api agree on the exact values.
 */
export type TaskPriority = -1 | 0 | 1 | 2;
