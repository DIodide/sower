...
export type Followup = typeof schema.followups.$inferSelect;
export type NewFollowup = typeof schema.followups.$inferInsert;
export type JobNote = typeof schema.jobNotes.$inferSelect;
export type NewJobNote = typeof schema.jobNotes.$inferInsert;
...
export type FillJob = typeof schema.fillJobs.$inferSelect;
export type NewFillJob = typeof schema.fillJobs.$inferInsert;
...
export type NewResumeVersion = typeof schema.resumeVersions.$inferInsert;
export type ResumeLink = typeof schema.resumeLinks.$inferSelect;
export type NewResumeLink = typeof schema.resumeLinks.$inferInsert;
